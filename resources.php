...
-->
<div class="container-tabset" id="learning-supports">
      ...
      <h4>RC of Pathologists</h4>
        ...
        <ul class="tab-panels">
            <li id="marzen" class="tab-panel">
                <div class="img-wrapper"><img src="static/images/logos/logo-expertpath.png" alt="ExpertPath logo" class='logo-expertpath'><img src="static/images/logos/logo-elsevier.jpeg" alt="Elsevier logo"><a href="https://www.expertpath.com/
" target="_blank" class="btn btn-brand-1">Learn More</a></div>
            ...
            <li id="rauchbier" class="tab-panel">
              <div class="img-wrapper"><img src="static/images/logos/logo-path-outlines.jpeg" alt="Pathology Outlines logo"><a href="https://www.pathologyoutlines.com/
...
" target="_blank" class="btn btn-brand-1">Learn More</a></div>
            ...
            <li id="dunkles" class="tab-panel">
                <div class="img-wrapper"><img src="static/images/logos/logo-rc-path.jpeg" alt="RC of Pathologists logo"><a href="https://www.rcpath.org/profession/guidelines/cancer-datasets-and-tissue-pathways.html
